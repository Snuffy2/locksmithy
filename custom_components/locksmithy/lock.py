...
if TYPE_CHECKING:
    from .helpers import LockSmithyTimer


@dataclass
class LockSmithyCodeSlotDayOfWeek:
...
@dataclass
class LockSmithyCodeSlot:
    """Separate instance for each code slot in a LockSmithy lock."""
    ...
    accesslimit_day_of_week: MutableMapping[int, LockSmithyCodeSlotDayOfWeek] | None = None


@dataclass
class LockSmithyLock:
    """Class to represent a LockSmithy lock."""

    lock_name: str
    lock_entity_id: str
    locksmithy_config_entry_id: str
    ...
    code_slots: MutableMapping[int, LockSmithyCodeSlot] | None = None
    ...
    autolock_timer: LockSmithyTimer | None = None
...
locksmithylock_type_lookup: MutableMapping[str, type] = {
    "lock_name": str,
    "lock_entity_id": str,
    "locksmithy_config_entry_id": str,
    ...
    # "autolock_timer": LockSmithyTimer,
    "retry_lock": bool,
    ...
    "accesslimit_day_of_week": MutableMapping[int, LockSmithyCodeSlotDayOfWeek],
}
